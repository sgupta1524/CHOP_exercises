...
df = pd.read_csv("/home/sonali/CHOP_exercises/Section2/Q2/total_visits/stacked_bar_total_visits.pdf")
M = df.iloc[:,1].tolist()
F = df.iloc[:,2].tolist()
M = [int(i) for i in M]
F = [int(i) for i in F]
...
plt.savefig('/home/sonali/CHOP_exercises/Section2/Q2/total_visits/stacked_bar_total_visits.pdf', dpi=my_dpi)
